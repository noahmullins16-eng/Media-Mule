...
export const TIER_CONFIG: Record<SubscriptionTier, TierConfig> = {
  starter: {
    label: "Free",
    price: 0,
    description: "A simple free plan to get you started, including 1 upload (up to 5GB) with full-quality preview and a large watermark for protection. Comes with built-in invoicing and a 4% transaction fee. Unlocks free 1 month Basic access for transactions over $9 (excluding Stripe fees).",
    maxFileSize: 5 * 1024 * 1024 * 1024,
    maxFileSizeLabel: "5 GB",
    totalStorage: 5 * 1024 * 1024 * 1024,
    totalStorageLabel: "5 GB",
    devices: 1,
    transactionFee: "4%",
    features: [
      { text: "1 Free Upload (up to 5 GB)", included: true },
      { text: "4% Transaction Fee", included: true },
      { text: "Free 1-Month Basic if fees exceed $9", included: true },
      { text: "Preview in Full Quality (option)", included: true },
      { text: "One Large Watermark on Preview", included: true },
